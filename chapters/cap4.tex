...
As medidas de tendência central como os valores "Presença", "Melhoria" e "Utilidade" são da escala ordinal, por isso é possível definir as métricas de "moda" e "mediana".
...
Considerando as respostas recebidas durante o estudo e utilizando os resultados de estatística descritiva podemos dividir as perguntas em 4 grupos:
...
\begin{table}[h]
	\centering
	\caption{2. Funcionalidade presente e é útil}
	\label{grupo2}
...
\begin{table}[h]
	\centering
	\caption{3. Funcionalidade presente e necessita melhorar}
	\label{grupo3}
	\begin{tabular}{|l|l|l|l|l|l|}
		\hline
		N & Funcionalidade & P & M & U & Características \\ \hline
