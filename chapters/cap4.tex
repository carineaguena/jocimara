...
O objetivo principal da aplicação deste experimento é definir se o \textit{framework} proposto por esta pesquisa de dissertação é uma ferramenta adequada para auxiliar no desenvolvimento de processos de ETL em dados estruturados, semi estruturados e não estruturados.
